---
title: Elegant linear albegra in R with the Matrix package
author: Jim Skinner
date: '2017-12-31'
slug: elegant-linear-albegra-in-r-with-the-matrix-package
categories: []
...
```{r}
  ...
  # Build a dense, symmetric and a sparse matrix. All are size d*d.
...
```{r, echo=FALSE}
  ...
  kable(sizes, align=c('llll'), row.names=FALSE)
```
